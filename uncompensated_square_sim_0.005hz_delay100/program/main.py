...
def run_simulation():
    ...
    for step in range(time_steps):
        ...
        target_angle_deg = target_angle_amplitude * signal.square(2.0 * math.pi * 0.005 * current_time)
    ...
    plt.tight_layout()
    plot_path = os.path.join(result_dir, 'uncompensated_square_0.005hz_delay100_results.png')
