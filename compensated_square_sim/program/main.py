...
def run_simulation():
    ...
    for step in range(time_steps):
        ...
        target_angle_deg = target_angle_amplitude * signal.square(2.0 * math.pi * 2.0 * current_time)
    ...
    plt.tight_layout()
    plot_path = os.path.join(result_dir, 'compensated_square_simulation_results.png')
